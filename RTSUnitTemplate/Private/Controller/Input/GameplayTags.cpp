...
void FGameplayTags::AddAllTags(UGameplayTagsManager& Manager)
{
	...
	AddTag(InputTag_1_Released, "InputTag.1_Released", "1_Released");
	AddTag(InputTag_2_Released, "InputTag.2_Released", "2_Released");
	AddTag(InputTag_3_Released, "InputTag.3_Released", "3_Released");
	AddTag(InputTag_4_Released, "InputTag.4_Released", "4_Released");
	AddTag(InputTag_5_Released, "InputTag.5_Released", "5_Released");
	AddTag(InputTag_6_Released, "InputTag.6_Released", "6_Released");
	...
	AddTag(InputTag_F1_Released, "InputTag.F1_Released", "F1_Released");
	AddTag(InputTag_F2_Released, "InputTag.F2_Released", "F2_Released");
	AddTag(InputTag_F3_Released, "InputTag.F3_Released", "F3_Released");
	AddTag(InputTag_F4_Released, "InputTag.F4_Released", "F4_Released");
	AddTag(InputTag_F5_Released, "InputTag.F5_Released", "F5_Released");
	AddTag(InputTag_F6_Released, "InputTag.F6_Released", "F6_Released");
