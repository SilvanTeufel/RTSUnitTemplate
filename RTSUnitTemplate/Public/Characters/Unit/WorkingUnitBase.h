...
public:
 ...
 UFUNCTION(BlueprintCallable, Category=Worker)
	void SpawnWorkAreaReplicated(TSubclassOf<AWorkArea> WorkAreaClass, AWaypoint* Waypoint, FVector SpawnLocation, const  FBuildingCost ConstructionCost, bool IsPaid = false, TSubclassOf<class AUnitBase> ConstructionUnitClass = nullptr);
